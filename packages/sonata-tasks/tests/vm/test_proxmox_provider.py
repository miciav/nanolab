...
@patch("sonata_tasks.vm.proxmox.ProxmoxClient")
...
@patch("sonata_tasks.vm.proxmox.ProxmoxClient")
@patch("sonata_tasks.vm.proxmox._find_ssh_private_key_path", return_value=Path("/home/user/.ssh/id_rsa"))
...
@patch("sonata_tasks.vm.proxmox.ProxmoxRoutingManager")
@patch("sonata_tasks.vm.proxmox.ProxmoxClient")
...
@patch("sonata_tasks.vm.proxmox.socket.create_connection")
@patch("sonata_tasks.vm.proxmox.subprocess.run")
@patch("sonata_tasks.vm.proxmox.ProxmoxRoutingManager")
@patch("sonata_tasks.vm.proxmox.ProxmoxClient")
...
def test_transfer_from_no_ssh_key(mock_client_cls, mock_subproc, mock_routing_cls) -> None:
    ...
    provider = _make_provider()
    req = _make_request(proxmox_ssh_key_path=None)
    with patch("sonata_tasks.vm.proxmox._find_ssh_private_key_path", return_value=None):
